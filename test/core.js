...
test( "Check jar.type", function() {
    ...
    strictEqual( jar.type( document.body.firstElementChild ), "html", "This type of data should be html" );
    strictEqual( jar.type( new XMLSerializer().serializeToString( document.body.firstElementChild ) ),
            "text", "This type of data should be text" );

    strictEqual( jar.type( new window.DOMParser().parseFromString( xmlStr, "text/xml") ),
        "xml", "This type of data should be xml" );
